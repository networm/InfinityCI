...
export function StatusIcon({ status, size = 16 }: { status: RunStatus | JobRunStatus; size?: number }) {
  ...
  if (status === "Success") {
    return (
      <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" style={{ color: color.fg }} aria-label="success">
  ...
  if (status === "Failed") {
    return (
      <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" style={{ color: color.fg }} aria-label="failed">
  ...
  if (status === "Running") {
    return (
      <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" style={{ color: color.fg }} aria-label="running" className="animate-spin">
  ...
  if (status === "Cancelled") {
    return (
      <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" style={{ color: color.fg }} aria-label="cancelled">
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" style={{ color: color.fg }} aria-label={String(status).toLowerCase()}>
