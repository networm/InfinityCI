---
slug: zcode-9-days-ci
title: 9 天、90 个提交：我用 Z Code 从零写出一个 CI 服务器
authors: [networm]
tags: [ai, cicd, unity]
date: 2026-09-20
---
...
> 💬 *配图位置：Infinity CI 首页 Dashboard（Jenkins 风格任务卡片）*
...
> 💬 *配图位置：Run 页面的 Blue Ocean 风格 DAG 依赖图*
...
> 💬 *配图位置：Unity 打包任务的 Run 详情页——DAG 图 + xterm.js 实时日志*
